...
int main()
{
  ...
  in.pointattributelist = (REAL *) malloc(in.numberofpoints *
                                          ...
                                          sizeof(REAL));
  in.pointattributelist[0] = 3.0;
  in.pointattributelist[1] = 2.0;
  in.pointattributelist[2] = 3.0;
  in.pointattributelist[3] = -400.0;
  in.pointattributelist[4] = 5.0;
  in.pointattributelist[5] = 6.0;


  in.edgelist = (REAL *) malloc(in.numberofpoints  * sizeof(REAL));
  ...
  in.pointmarkerlist[4] = 4;
  in.pointmarkerlist[5] = 5;
